...
4. Follow the vibes: This step is actually an inner loop consisting of three sub-steps:
    ...
    3. determine cooperation style. From time to time, you'll need to refine the way you want to collaborate with your toolbox. Here’s an example.
...
My ideas comes out most of times from real-life problems that i can’t fix. I’m often wondering if i could build something to help me, and this helps me in three ways:
...
A year later, John Carmack developed the [Doom Engine](https://en.wikipedia.org/wiki/Doom_engine) using the same technology, and we were all shocked by Doom
